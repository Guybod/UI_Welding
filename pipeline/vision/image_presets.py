...
_PRESETS: dict[str, ImageProcessConfig] = {
    PRESET_LINEART: ImageProcessConfig(
        ...
        invert=False,
        max_contours=50,
        contour_strategy="all",
        fill_before_contour=False,
        fill_holes=False,
        keep_external_only=False,
    ),
    PRESET_SILHOUETTE: ImageProcessConfig(
        ...
        max_contours=20,
        invert=False,
        contour_strategy="external",
        fill_before_contour=True,
        fill_holes=True,
        keep_external_only=True,
    ),
...
_BETA_HINTS: dict[str, str] = {
    PRESET_PHOTO_EDGE_BETA: "照片边缘为 Beta：需配合预览调参，不保证效果；可能出现双层边。",

...
SKELETON_MULTILINE_ZH = "焊接骨架模式不支持多行文字，请使用单行。"
SKELETON_MULTILINE_EN = "Skeleton weld mode does not support multiline text."
...
def validate_weld_skeleton_text(text: str, *, lang: str = "zh") -> str | None:
    ...
    if has_skeleton_multiline(text):
        return SKELETON_MULTILINE_EN if lang == "en" else SKELETON_MULTILINE_ZH

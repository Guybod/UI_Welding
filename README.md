...
机器人 JSON/TCP/UDP 协议见 **[planAPI.md](planAPI.md)**。  
系统设计与模块边界见 **[ARCHITECTURE.md](ARCHITECTURE.md)**。
...
view3d/              首页 3D 加载与渲染
styles/              QSS 主题
planAPI.md           机器人 API 文档
ARCHITECTURE.md      架构与维护说明（本文档姊妹篇）
```
...
1. 先读 **ARCHITECTURE.md** 的线程规则与数据流，再改通信或运动控制。  
2. 改机器人接口时同步 **planAPI.md**（若协议变更）。  
...
| [ARCHITECTURE.md](ARCHITECTURE.md) | 架构、模块、扩展与禁忌 |
| [planAPI.md](planAPI.md) | 机器人通信 API |
| [docs/HANDOFF_PHASE9.md](docs/HANDOFF_PHASE9.md) | 焊接 Phase 9 历史交接 |
